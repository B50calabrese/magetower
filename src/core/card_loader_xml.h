...
namespace core {
    ...
    public:
        ...
        /**
        * Loads cards from the given XML file and populates the CardRegistry with the definitions.
    ...
    private:
        std::shared_ptr<common::ecs::Component> parseComponent(tinyxml2::XMLElement* component_element);
    };
