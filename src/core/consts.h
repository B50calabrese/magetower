...
const static int CARD_IN_HAND_ZOOM_WIDTH =
    CARD_IN_HAND_WIDTH * CARD_IN_HAND_ZOOM_SCALE;
const static int CARD_IN_HAND_ZOOM_HEIGHT =
    CARD_IN_HAND_HEIGHT * CARD_IN_HAND_ZOOM_SCALE;
...
const static glm::vec2 ENEMY_HAND_CENTER =
    glm::vec2(HALF_SCREEN_WIDTH, SCREEN_HEIGHT - CARD_HOLDING_HEIGHT);

const common::utils::BoundingBox2D BOARD_BOUNDING_BOX = {
    glm::vec2(268.0f, 232.0f), glm::vec2(1384.0f, 259.0f)};

const common::utils::BoundingBox2D PLAYER_HAND_BOUNDING_BOX = {
    glm::vec2(0.0f), glm::vec2(SCREEN_WIDTH, 208.0f)};
