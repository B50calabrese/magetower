...
namespace common {
    namespace twod {
        ...
        void SpriteRenderer::DrawSprite(Texture& texture, glm::mat4 model_matrix, glm::vec4 color) {
        ...
        glm::mat4 SpriteRenderer::generateModelMatrix(glm::vec2 position, glm::vec2 size, float rotate) {
