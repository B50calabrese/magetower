...
namespace common {
    namespace twod {
        ...
        public:
            ...
            void DrawSprite(Texture& texture, glm::mat4 model_matrix, glm::vec4 color = glm::vec4(1.0f));
        ...
        private:
            ...
            glm::mat4 generateModelMatrix(glm::vec2 position, glm::vec2 size, float rotate);
