...
namespace common {
    namespace twod {
        ...
        public:
            ...
            void RenderText(std::string text, float x, float y, float scale, glm::vec3 color, float rotate = 0.0f);

            void RenderTextInBoundingBox(std::string text, BoundingBox2D bounding_box, float scale, glm::vec3 color, bool scale_to_fit = false);
        ...
        private:
            ...
            */
            ...
            glm::vec2 computeWordFinalPosition(std::string word, float x, float y, float scale);

            float computeOptimalScale(std::string word, float scale, BoundingBox2D bounding_box);
