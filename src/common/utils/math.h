...
/**
 * Given a start value, an end value, and a parameter t (typically between 0 and
 * 1), this function calculates the intermediate value.
 *
 * @param T The data type for the values (e.g., float, double).
