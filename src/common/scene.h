#ifndef MAGETOWER_SRC_COMMON_SCENE_H_
#define MAGETOWER_SRC_COMMON_SCENE_H_
...
class Scene {
 public:
  ...
  int next_scene_id() const { return next_scene_id_; }
...
#endif  // MAGETOWER_SRC_COMMON_SCENE_H_